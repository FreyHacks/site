...
const Privacy = () => {
  return (
    <div className='w-full h-full px-4 py-6'>
      ...
      <p>Your privacy is important to us. It is Freyhacks&#39; policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <a href="https://freyhacks.tech/">freyhacks.tech</a>, submission forms and other mediums. </p>
      <p>This policy is effective as of 13 March 2022 and was last updated on 13 March 2022. </p>
      <h3>Information We Collect</h3>
      <p>Information we collect includes both information you knowingly and actively provide us when participating in our hackathon or any of our promotions, and any information automatically sent by your devices in the course of accessing services. </p>
      <h4>Log Data</h4>
      ...
      <p>We only collect and use your personal information when we have a legitimate reason for doing so. In which instance, we only require you to send the personal information that is reasonably necessary to participate in our hackathon. </p>
      <h4>Collection and Use of Information</h4>
      <p>We may collect personal information from you when you do any of the following: </p>
      <ul>
        <li>Enter any of our mini-events, workshops, giveaways, and surveys</li>
      ...
      <ul>
        ...
        <li>to run mini-events, workshops, giveaways, and surveys, and/or offer additional benefits to you</li>
      </ul>
      ...
      <ul>
        ...
        <li>sponsors or promoters of any mini-events, workshops, giveaways, and surveys, or promotion we run</li>
