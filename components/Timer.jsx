...
const d=()=>{
  var t1 = new Date();
  var t2 = new Date(2022,6,24, 0, 0, 0, 0);
  ...
  return( 
    ...
    <div className='border-white border-2 lg:h-[100px] w-[90%] md:w-[65%] lg:w-[50%] flex flex-wrap items-center justify-between py-1 md:py-1.5 px-4 md:px-8  font-medium'>
      <div className='flex flex-col items-center'>
        <p className='text-2xl md:text-4xl lg:text-5xl'>{days}</p>
        <p className='text-md md:text-3xl'>days</p>
      </div>
      <p className='text-4xl sm:text-5xl sm:-mt-4'> : </p>
      <div className='flex flex-col items-center'>
        <p className='text-2xl md:text-4xl lg:text-5xl'>{hours}</p>
        <p className='text-md md:text-3xl'>hours</p>
      </div>
      <p className='text-4xl sm:text-5xl sm:-mt-4'> : </p>
      <div className='flex flex-col items-center'>
        <p className='text-2xl md:text-4xl lg:text-5xl'>{minutes}</p>
        <p className='text-md md:text-3xl'>minutes</p>
      </div>
      <p className='text-4xl sm:text-5xl sm:-mt-4'> : </p>
      <div className='flex flex-col items-center'>
        <p className='text-2xl md:text-4xl lg:text-5xl'>{seconds}</p>
        <p className='text-md md:text-3xl'>seconds</p>
      </div>
    </div>
    {/* </>
} */}
